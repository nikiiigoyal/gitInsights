// src/pages/SignUpPage.tsx - Fixed version with Sonner
...
const SignUpPage = () => {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    if (password !== confirmPassword) {
      toast.error("Passwords don't match"); // Use toast.error
      return;
    }
    ...
    if (success) {
      toast.success("Account created successfully!"); // Use toast.success
      navigate('/dashboard');
    } else {
